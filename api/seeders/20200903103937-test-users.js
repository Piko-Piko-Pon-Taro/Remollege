...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('Users', [ 
      { id:1, name:'user', email:'turunasi@ruri.waseda.jp', password:'userpass', profile:'userです.', createdAt:'2020-08-14 00:00:00', updatedAt:'2020-08-14 00:00:00'},
      { id:2, name:'店長', email:'pikopiko@gmail.com', password:'userpass', profile:'店長です.', createdAt:'2020-08-15 00:00:00', updatedAt:'2020-08-15 00:00:00'},
      { id:3, name:'店員', email:'pikopiko@gmail.com', password:'userpass', profile:'店員です.', createdAt:'2020-08-15 00:00:00', updatedAt:'2020-08-15 00:00:00'},
